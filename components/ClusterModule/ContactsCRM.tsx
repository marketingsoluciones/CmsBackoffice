  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ minHeight: 0, maxHeight: '100vh', padding: '16px', backgroundColor: '#F9FAFB' }}>
      ...
      <PipedriveDetailModal
        ...
        filesContent={
          <div>
            <div className="w-full rounded-lg border-2 border-dashed p-8 text-center" style={{ borderColor: "#D1D5DB", backgroundColor: "#F9FAFB" }}>
              <button className="px-4 py-2 rounded-lg text-sm font-medium text-white mb-2" style={{ backgroundColor: "#10B981" }}>
                Upload files
              </button>
              <p className="text-sm" style={{ color: "#6B7280" }}>or drag files here</p>
            </div>
          </div>
        }
      />
