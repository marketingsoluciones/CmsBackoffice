...
import ButtonConfigEvents from "../../Events/ButtonConfigEvents";
...
const ConfigurarEvento: FC <propsConfigurarEvento> = ({componentState,setComponentState}) => {
  ...
  [
    {
      ...
      content:"Cambia el nombre, fecha, flyer, artistas, música o especifica los términos.",
      component: ()=>{router.push("/events/data-event")},
    },
    {
      title:"Asistencia usuarios",
      img: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
    </svg>,
      bg:"bg-orange-100",
      textbg:"text-orange-600",
      content:"Asigna a cada usuario el número de copas, chupitos o consumiciones.",
      component: ()=>{router.push("/events/attendance")},
    },
    {
    ...
    },
    {
      ...
      bg:"bg-orange-100",
      textbg:"text-orange-600",
      content:"Activa o desactiva los canales de venta que podrán ver este evento.",
  ...
  return (
    <div className="w-[100%] h-[100vh] flex flex-col items-center justify-start pt-[20px] px-[10px] box-border gap-[37px] tracking-[normal] text-center">
      ...
      {DataComponent.map((items,idx) => ( 
            <div key={idx} >
      <Component3CE items={items} componentState={componentState} setComponentState={setComponentState}/>
          </div>
        ))}
        </div>
