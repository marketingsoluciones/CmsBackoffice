...
const EntradasTarifa: FC <propsEntradasTarifa> = ({componentState, setComponentState}) => {
  ...
  return (
    <div className="w-full h-[90vh] flex flex-col items-start justify-start py-6 px-4 gap-4 overflow-auto box-border tracking-[normal] text-left text-black font-semibold">
            <div className="flex items-center justify-center">
        <ModoDemo />
      </div>
      <ButtonEventsBack text="Entradas" onClick={() => { router.push("/events/configure-event") }}/>

      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-sm text-black">
        <div className="w-auto rounded-md bg-white shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] flex flex-col items-center justify-start py-7 px-0 box-border gap-[28px] max-w-full mq800:pt-5 mq800:pb-5 mq800:box-border">
          ...
          <ButtonEvents text="Guardar" onClick={() => { router.push("/events/ticket-options") }}/>
        </div>
      </div>
      {
  addAñadirPrecio ? (
