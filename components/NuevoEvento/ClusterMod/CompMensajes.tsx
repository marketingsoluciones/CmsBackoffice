...
export const CompMensajes: FC<propsMensajesC> = ({ componentState, setComponentState }) => {

  return (
    <div className="w-[100%] h-[90vh] overflow-y-auto pr-4   text-[#21232C] font-semibold ">
      <div className=" rounded-lg bg-white flex flex-col items-center justify-center pt-5 gap-[20px] text-center text-6xl text-azul pb-10">
        ...
        <section className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-4 box-border gap-[52px] max-w-full text-left text-3xs text-carbonaphrd-pipedrive-com-leads-web-visitors-1318x573-default-shark font-carbonaphrd-pipedrive-com-leads-messaging-1318x573-default-inter-semi-bold-14 mq975:gap-[26px_52px]">
          ...
          <div className="self-stretch w-full flex flex-row items-center justify-center  max-w-full gap-3 ">
            ...
            <div className=" flex flex-col items-start justify-start gap-[16px] min-w-[285px] max-w-full text-2xl">
          ...
          <div className="w-auto flex flex-row  justify-center space-x-1 text-sm">
            <div className="flex-1 leading-[20px] font-medium ">
