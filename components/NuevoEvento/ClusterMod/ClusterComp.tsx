...
interface propsClusterComp {
    componentState: any;
    setComponentState: any;
  
  }

const ClusterComp: FC <propsClusterComp> = ({componentState, setComponentState}) => {
  return (
    ...
    {/*  slidevar */} 
      <div className="h-full w-auto bg-gray-100 overflow-hidden shrink-0 flex flex-col items-start justify-start pt-5 pb-[1571.5px] pr-[7px] pl-[19.200000000000728px] box-border gap-[21px] mq700:hidden mq450:pb-[432px] mq450:box-border mq975:pb-[664px] mq975:box-border">
        <div className="self-stretch h-7 flex flex-row items-start justify-start pt-0 pb-2.5 pr-0 pl-[1.7999999999992724px] box-border">
          <div className="self-stretch flex-1 flex flex-row items-end justify-start gap-[8.9px]">
            <img
              className="h-[16.5px] w-[18.3px] relative shrink-0 [debug_commit:f6aba90]"
              loading="lazy"
              alt=""
              src="ModuloEvento/buzon.svg"
            />
            <div className="h-[18px] flex-1 relative leading-[18px] inline-block shrink-0 [debug_commit:f6aba90]">
              Buzón de prospectos
            </div>
          </div>
        </div>
        <div className="self-stretch flex-1 flex flex-col items-start justify-start py-0 pr-[26px] pl-0 gap-[30px]">
          <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[21px]">
            <div className="flex flex-row items-start justify-start py-0 px-px">
              <div className="h-[18px] w-[100px] relative leading-[18px] font-semibold inline-block min-w-[100px]">
                POTENCIADORES
              </div>
            </div>
            <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[19.33px]">
              <div className="w-[107px] h-[21px] flex flex-row items-start justify-start py-0 px-0.5 box-border">
                <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[6px]">
                  <img
                    className="h-[21px] w-[21px] relative overflow-hidden shrink-0 min-h-[21px]"
                    loading="lazy"
                    alt=""
                    src="ModuloEvento/mensaje.svg"
                  />
              ...
              <div className="w-20 flex flex-row items-start justify-start py-0 px-px box-border">
              ...
              <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[18px]">
                <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[7px]">
                  <img
                    className="h-[22px] w-[22px] relative overflow-hidden shrink-0 min-h-[22px]"
                    loading="lazy"
                    alt=""
                    src="ModuloEvento/formulario.svg"
                  />
                ...
                <div className="w-[66px] flex flex-row items-start justify-start py-0 px-px box-border">
                  <div className="flex-1 flex flex-row items-end justify-start gap-[10px]">
                    <div className="h-[15px] flex flex-col items-start justify-end pt-0 px-0 pb-[1.5px] box-border">
                      <img
                        className="w-[18px] h-[13.5px] relative"
                        loading="lazy"
                        alt=""
                        src="MooduloEvento/leads.svg"
                      />
                    </div>
                    <div className="h-[18px] flex-1 relative leading-[18px] inline-block">
                      Leads
                ...
                <div className="flex flex-row items-start justify-start gap-[9px]">
                  <div className="flex flex-col items-start justify-start pt-px px-0 pb-0">
                    <div className="w-[18px] h-[18px] relative overflow-hidden shrink-0">
                      <img
                        className="absolute top-[0px] left-[0px] w-[18px] h-[18px] overflow-hidden z-[1]"
                        loading="lazy"
                        alt=""
                        src="ModuloEvento/invitados.svg"
                      />
                    </div>
                  </div>
                  <div className="h-[18px] w-[55px] relative leading-[18px] inline-block min-w-[55px]">
                    Invitados
                  </div>
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-1.5 pl-px">
            <div className="flex-1 flex flex-col items-start justify-start gap-[21px]">
              <div className="w-[99px] h-[18px] relative leading-[18px] font-semibold inline-block min-w-[99px]">
                COMPLEMENTOS
              </div>
              <div className="flex flex-row items-start justify-start gap-[10px]">
                <div className="h-[19px] flex flex-col items-start justify-start pt-px px-0 pb-0 box-border">
                  <img
                    ...
                    loading="lazy"
                    alt=""
                    src="ModuloEvento/web.svg"
                  />
                </div>
                <div className="h-[18px] w-[94px] relative leading-[18px] inline-block min-w-[94px]">
                  Visitas a la web
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-row items-start justify-start py-0 px-px">
            <div className="h-[18px] w-24 relative leading-[18px] font-semibold inline-block min-w-[96px]">
              INTEGRACIONES
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-row items-start justify-start gap-[10px]">
            <div className="h-[19.5px] flex flex-col items-start justify-start pt-[1.5px] px-0 pb-0 box-border">
              <img
                ...
                loading="lazy"
                alt=""
                src="ModuloEvento/mensaje2.svg"
              />
            </div>
            <div className="h-[18px] w-[57px] relative leading-[18px] inline-block min-w-[57px]">
              Mensajes
            </div>
          </div>
        </div>
