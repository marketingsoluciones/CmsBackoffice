...
const Card1: FC<propsCard1> = ({icon, title, content}) => {
  return (
    <div className="w-[50%] rounded-lg bg-white overflow-hidden flex flex-row items-center justify-start py-0 pr-2.5 pl-0 box-border gap-[5px] min-w-[237px] max-w-full mq1100:flex-wrap mq1100:pl-2.5 mq1100:pt-2.5 mq1100:pb-2.5 mq1100:box-border">
