...
export const PlantillaMenuTable = ({ actionButton, setActionButton, setComponentState }) => {
    ...
    return (
        <div className="space-y-4 w-full  ">
            <div>
                ...
                <p className=" text-sm bg-white p-2 rounded-lg">Crea diversas plantillas de menú para enlazar con tus eventos.   </p>
            </div>
