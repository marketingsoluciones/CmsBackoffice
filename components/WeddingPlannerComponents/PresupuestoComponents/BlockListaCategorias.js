...
import {DotsOpcionesIcon, PlusCirculoIcon} from "../../Icons/index"
import { EventContextProvider } from "../../../context/EventContext";
import FormCrearCategoria from "../../formularios/FormCrearCategoria";
      ...
      <>
        ...
        <div className="bg-white w-full shadow-md rounded-xl h-max ">
          <button
            ...
            className="focus:outline-none bg-rosa  rounded-xl font-display font-light text-md flex gap-2 w-full py-1 items-center justify-center text-white hover:scale-105 transition transform"
          >
