export const PantallaInformativaSinPermiso = () => {
    return (
        <>
            hola
        </>
...
export const PantallaInformativaCrearAPP = () => {
    return (
        <div className="w-[100%] h-[calc(100vh-90px)] bg-white flex flex-col items-center justify-center gap-4 rounded-xl mx-5 my-2 truncate* ">

            <h1 className=" lg:text-[30px] 2xl:text-5xl text-[#21232C] font-semibold">
                Lanza tu app de marca blanca al éxito.

            </h1>

            <div className="flex flex-col items-start justify-start gap-[20px] text-gray-400 ">
                <p className="flex lg:max-w-[700px] 2xl:max-w-[1007px]  text-center">
                    Lanza tu app en cuestión de días y sin complicaciones. Nuestra plataforma te permite publicar tu app de marca blanca en las tiendas de apps de forma rápida y sencilla. Por tan solo 160€, tendrás tu propia app personalizada. ¡Ahorra tiempo y dinero!
                </p>
            </div>
