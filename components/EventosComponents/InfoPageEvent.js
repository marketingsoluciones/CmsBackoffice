...
export const InfoPageEvent = ({ actionButton, setActionButton, openModal, setOpenModal }) => {
    ...
    return (
        <>
            <div className="bg-white  space-y-5 rounded-xl flex flex-col items-center justify-center h-full py-16">
                ...
                <div className="grid md:grid-cols-2  md:space-x-10 space-y-3 md:space-y-0  " >
                    <button type="button" onClick={() => event != null ? setActionButton(!actionButton): toast("error", "No tienes eventos creados")} className=" py-2 px-7 border border-gray-400 rounded-lg w-full text-base">
                        Ver mis eventos
                    </button>
